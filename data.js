export const philosophyData = {
  narrative: [
    { type: "h3", content: "데이터에서 브랜드의 흐름을 발견합니다." },
    {
      type: "p",
      content:
        "차가운 데이터와 시스템의 언어(Language of IT)로 사용자의 행동을 분석하고, 따뜻한 감성과 스토리의 언어(Language of Brand)로 그들의 마음을 이해합니다. 저는 이 두 세계를 잇는 '브랜드 플랫폼 기획자'입니다. 기술적 배경을 통해 서비스의 구조를 설계하고, 브랜드에 대한 깊은 이해를 바탕으로 고객이 몰입할 수 있는 경험의 흐름을 만듭니다.",
    },
    {
      type: "p",
      content:
        "사용자에게는 자연스러운 즐거움을, 비즈니스에게는 지속가능한 성장을 제공하는 플랫폼을 구축하는 것이 저의 목표입니다. 데이터 기반의 논리와 감성적 가치를 융합하여, 모두가 사랑할 수밖에 없는 브랜드 경험을 설계합니다.",
    },
  ],
  pyramid: [
...
export const projectsData = [
  {
    ...
    reinterpretation:
      "'판매 채널'에서 '가치를 선물하는 브랜드 경험 채널'로 포지셔닝을 전환했습니다. 브랜드 철학을 디지털 고객 여정으로 번역하여, 사용자가 '선물'이라는 감성적 가치를 온전히 느낄 수 있는 구조를 설계했습니다.",
    result:
      "선물하기 전용 UX, 콘텐츠, 패키지를 기획하여 '선물할 땐 오설록'이라는 독자적 포지션을 구축하고, 유의미한 구매 전환율 상승을 이끌었습니다.",
    stat: null,
  ...
  },
  {
    ...
    reinterpretation:
      "정량 데이터(로그) 분석으로 '무엇'이 문제인지 파악하고, 문화적 맥락에 기반한 정성적 가설로 '왜' 그런지를 추론했습니다. 이는 단순 푸시 알림이 아닌, 사용자의 '놓친 기회'를 되찾아주는 '데이터 기반 공감(Data-driven Empathy)' 전략이었습니다.",
    result:
      "탐색 이탈 지점 분석 기반 개인화 매물 알림 로직 개선으로 사용자의 불편을 해소, 클릭률 1.4배 및 거래수 2배 증가라는 비즈니스 성과를 창출했습니다.",
  ...
  },
  {
    ...
    reinterpretation:
      "사용자 심층 인터뷰를 통해 '절약'의 본질이 '현명한 소비'이며, 이는 '나만의 취향을 쌓아가는 과정'이라는 인사이트를 발견했습니다. 브랜드 핵심 가치를 기능이 아닌 '자기표현'이라는 감성적 가치로 재정의했습니다.",
    result:
      "'절약'에서 '나만의 소비 취향 기록'으로 리포지셔닝하여 초기 사용자 305명을 확보하고, 긍정적인 브랜드 인식을 형성하며 서비스의 방향성을 재설정했습니다.",
